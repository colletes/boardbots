...
const SITE_I18N = {
  pt: {
    ...
    game_utek_desc: 'O mesmo jogo de Tiny Epic Kingdoms: dois modos solo, incluindo a variante comunitária e o Modo Solo Oficial do manual.',
    ...
    game_spacebase_desc: 'Modo Automa (Joanna/Devin/Clarie) e Modo SoloPlay (Ataque à Base).',
    ...
    game_uteg_desc: 'Automa Rogue Galaxy com 2 modos: Modo Solo Oficial do Manual e Variante Solo com d6 3D (Stellar), Scanner Navegacional e suporte a satélites.',
    ...
    game_wingspan_desc: 'Automa completo com suporte modular a todas as expansões (Europa, Oceania, Ásia e Américas), Modo Dueto e Automarazzi.',
  ...
  en: {
    ...
    game_utek_title: 'Ultra Tiny Epic Kingdoms / Tiny Epic Kingdoms',
    game_utek_desc: 'The same game as Tiny Epic Kingdoms: two solo modes, including the community variant and the rulebook\'s Official Solo Mode.',
    game_cafebaras_title: 'Café Baras',
    ...
    game_spacebase_title: 'Space Base',
    game_spacebase_desc: 'Automa Mode (Joanna/Devin/Clarie) and SoloPlay Mode (Base Attack).',
    game_7wd_title: '7 Wonders Duel',
    game_lotrduel_title: 'Lord of the Rings: Duel for Middle-earth',
    game_mistborn_title: 'Mistborn',
    ...
    game_uteg_title: 'Ultra Tiny Epic Galaxies / Tiny Epic Galaxies',
    game_uteg_desc: 'Rogue Galaxy Automa with 2 modes: Official Rulebook Mode and 3D d6 Solo Variant (Stellar theme), Navigational Scanner, and satellite support.',
    game_ted_title: 'Tiny Epic Dinosaurs',
    ...
    game_wingspan_title: 'Wingspan',
    game_wingspan_desc: 'Full Automa with modular support for all expansions (Europe, Oceania, Asia, and Americas), Duet Mode, and Automarazzi.',
