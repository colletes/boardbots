...
- **Dado 3D Responsivo:** Implementação do `@3d-dice/dice-box` com "Dice Tray" dinâmico (dado aparece fixado no container de onde foi rolado), Web Worker CORS corrigido, `assetPath` sincronizado via unpkg, e Failsafe Global de 3 segundos para modo off-line/erros.
